; (function ($, window, document, undefined) {
    ...
    var templates = {
        ...
        treeViewLink: '<a style="text-transformation:uppercase;color:black;text-decoration:none;font-family:Arial"></a>'
    };
    /**
    ...
    $.extend(bstreeView.prototype, {
        ...
        build: function (parentElement, nodes, depth) {
            ...
            $.each(nodes, function addNodes(id, node) {
                ...
                if (node.href) {
                    treeItem.text('');
                    var treeItemLink = $(templates.treeViewLink);
                    // Set node Text.
                    treeItemLink.attr('href', node.href);
                    treeItemLink.append(node.text);
                    treeItem.append(treeItemLink);
